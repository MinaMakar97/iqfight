		...
		return (
			<div div className="loginn">
				...
				<form className="form" onSubmit={this.registerSubmit}>
					...
					<input className="form-control-lg shadow mb-4" maxLength="50" type="password" placeholder="Password" name = "password" required></input>
					<div className="form-control-lg shadow" style={{ borderRadius: "10px", display: "flex",backgroundColor:"white"}}>
						...
						<p id="name-avatar" className="sfoglia">{this.state.filePath}</p>
						<label class="prova">Sfoglia<input type="file" name = "avatar" style={{display: "none"}} onChange={this.cambiaFile}></input></label>
					</div>
