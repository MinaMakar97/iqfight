...
class CardInfo extends React.Component {
	componentDidUpdate() {
		if (this.props.id && !this.props.disabled) document.getElementById(this.props.id).select();
	}

	render() {
		return (
			<div className={"div-card shadow " + this.props.className + " row mb-0"} style={this.props.style}>
